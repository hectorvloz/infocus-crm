...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-2xl font-extrabold text-slate-900">Editar Proveedor</h1>
    </div>
        ...
        <form action="{{ route('proveedores.update', $proveedor['id']) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nombre" required value="{{ $proveedor['nombre'] }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="rfc" value="{{ $proveedor['rfc'] ?? '' }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="contacto" value="{{ $proveedor['contacto'] ?? '' }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ $proveedor['email'] ?? '' }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="telefono" value="{{ $proveedor['telefono'] ?? '' }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">
                    </div>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <select name="categoria" data-native-select="1" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm bg-white">
                            ...
                            @foreach(($categoryOptions ?? []) as $option)
                                <option value="{{ $option }}" {{ ($proveedor['categoria'] ?? '') === $option ? 'selected' : '' }}>{{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                    <p class="mt-1 text-xs text-slate-500">Esta categoria solo organiza proveedores; la categoria del gasto se define al registrar cada gasto.</p>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="direccion" rows="2" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">{{ $proveedor['direccion'] ?? '' }}</textarea>
                </div>
            </div>
