...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-2xl font-extrabold text-slate-900">Registrar Nuevo Gasto</h1>
    </div>
        ...
        <form action="{{ route('gastos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="concepto" required class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm" placeholder="Ej. Pago de servidor, Material de oficina...">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="monto" required class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm" placeholder="0.00">
                    </div>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <select name="moneda" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm">
                            @foreach($currencies as $c)
                                <option value="{{ $c }}" @selected($base===$c)>{{ $c }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="fecha" name="fecha" required value="{{ date('Y-m-d') }}" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm bg-white cursor-pointer" placeholder="Seleccionar fecha">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-slate-400">¿No está en la lista? <a href="{{ route('proveedores.create') }}" class="text-blue-600 hover:underline">Crear nuevo</a></p>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="dropdown-container" id="categoriaDropdown" data-categories='@json($categories ?? [])'>
                    <div class="dropdown-trigger">
                        <svg class="h-5 w-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                        <input type="text" id="categoriaSearch" placeholder="Oficina, Software, Viajes..." autocomplete="off">
                ...
                <input type="hidden" name="categoria" id="categoriaField">
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <div class="flex items-center h-5">
                            <input id="es_recurrente" name="es_recurrente" type="checkbox" value="1" class="focus:ring-[#ecfe88] h-4 w-4 text-slate-900 border-gray-300 rounded">
                        </div>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="comprobante-file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-300 border-dashed rounded-xl cursor-pointer bg-slate-50 hover:bg-slate-100 transition-colors">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="mb-2 text-sm text-slate-500"><span class="font-semibold">Click para subir</span> o arrastra y suelta</p>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <textarea name="notas" rows="3" class="block w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-xl focus:ring-[#ecfe88] focus:border-[#ecfe88] sm:text-sm" placeholder="Detalles extra..."></textarea>
                </div>
            </div>
