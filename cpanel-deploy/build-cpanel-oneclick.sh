#!/usr/bin/env bash
# InFocus CRM - paquete "subir y descomprimir" para raiz del subdominio.
# Estructura Laravel estandar (incluye carpeta public/).

set -e

OUTPUT="deploy_infocus_crm_ONECLICK_$(date +%Y%m%d_%H%M%S).zip"
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

echo "================================================="
echo "  InFocus CRM - Generando paquete ONECLICK"
echo "================================================="
...
# Forzar front controller raiz compatible con hosts que no aplican rewrite como esperamos.
cp "$SCRIPT_DIR/oneclick_root_index.php" "$APP_DIR/index.php"
...
echo "================================================="
echo ""
echo "Extrae este ZIP en la raiz del subdominio."
