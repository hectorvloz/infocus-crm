...
class RoleAccess
{
    ...
    private const ROUTE_PERMISSIONS = [
        ...
        'documentos.thumbnail' => 'documentos.read',
        ...
        'social-media.index' => 'social-media.read',
        'social-media.meta.connect' => 'social-media.sync',
        'social-media.meta.callback' => 'social-media.sync',
        'social-media.meta.disconnect' => 'social-media.sync',
        'social-media.tiktok.connect' => 'social-media.sync',
        'social-media.tiktok.callback' => 'social-media.sync',
        'social-media.accounts.store' => 'social-media.create',
        'social-media.calendar.store' => 'social-media.create',
        'social-media.calendar.update' => 'social-media.update',
        'social-media.calendar.delete' => 'social-media.delete',
        'social-media.accounts.update' => 'social-media.update',
        'api.social-media.sync' => 'social-media.sync',
        'api.social-media.leads.convert' => 'social-media.update',
        ...
        'api.proyectos.ia-apoyo' => 'proyectos.update',
        'api.proyectos.tareas.ia-apoyo' => 'proyectos.update',
    ...
    private const FIRST_ALLOWED_ROUTES = [
        ...
        'social-media.read' => 'social-media.index',
